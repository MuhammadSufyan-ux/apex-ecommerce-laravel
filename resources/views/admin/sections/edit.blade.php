...
<div class="mb-10">
    ...
    <h2 class="text-2xl font-black text-black uppercase tracking-tighter">Edit Section</h2>
</div>
                ...
                <div class="bg-white p-8 border border-gray-100 shadow-sm rounded-none space-y-6">
                    ...
                    <div class="space-y-4">
                        <label class="flex items-center gap-3 cursor-pointer group bg-gray-50 p-4 border border-gray-100 hover:border-gold transition-all">
                            <input type="checkbox" name="is_active" {{ $section->is_active ? 'checked' : '' }} class="w-5 h-5 border-gray-300 text-gold focus:ring-gold rounded-none">
                        ...
                        <div class="space-y-3 pt-4 border-t border-gray-50">
                            ...
                            <label class="flex items-start gap-3 cursor-pointer group bg-white p-4 border-2 border-gray-200 hover:border-black transition-all">
                                <input type="radio" name="scroll_type" value="vertical" {{ $section->scroll_type === 'vertical' ? 'checked' : '' }} class="mt-1 w-5 h-5 border-gray-300 text-black focus:ring-black">
                                <div>
                            ...
                            <label class="flex items-start gap-3 cursor-pointer group bg-white p-4 border-2 border-gray-200 hover:border-black transition-all">
                                <input type="radio" name="scroll_type" value="horizontal" {{ $section->scroll_type === 'horizontal' ? 'checked' : '' }} class="mt-1 w-5 h-5 border-gray-300 text-black focus:ring-black">
                                <div>
                                    <span class="block text-xs font-bold uppercase tracking-widest text-black">
